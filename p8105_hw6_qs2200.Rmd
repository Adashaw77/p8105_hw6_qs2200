...
rs = regsubsets(bwt ~ babysex + bhead + blength + delwt + fincome + gaweeks + mheight + mrace + parity + ppwt + smoken, data = birthweight_df, max.size = 1)
b = summary(rs)

par(mar=c(4,4,1,1))
par(mfrow=c(1,2))

plot(2:9, b$cp, xlab="No of parameters", ylab="Cp Statistic")
abline(0,1)

plot(2:9, b$adjr2, xlab="No of parameters", ylab="Adj R2")
